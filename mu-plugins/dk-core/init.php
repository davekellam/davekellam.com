...
require_once WPMU_PLUGIN_DIR . '/dk-core/goodreads-import.php';
require_once WPMU_PLUGIN_DIR . '/dk-core/book-meta.php';
require_once WPMU_PLUGIN_DIR . '/dk-core/changelog-dashboard.php';
