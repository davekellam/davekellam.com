 ...
 * @return array
 */
function spacemonkey_body_classes( $classes ) {
...
add_filter( 'body_class', 'spacemonkey_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function spacemonkey_pingback_header() {
	if ( is_singular() && pings_open() ) {
		echo '<link rel="pingback" href="', esc_url( get_bloginfo( 'pingback_url' ) ), '">';
	}
}
add_action( 'wp_head', 'spacemonkey_pingback_header' );
